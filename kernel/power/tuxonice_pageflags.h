...
#define PagePageset1(page) (memory_bm_test_bit(&pageset1_map, page_to_pfn(page)))
#define SetPagePageset1(page) (memory_bm_set_bit(&pageset1_map, page_to_pfn(page)))
#define ClearPagePageset1(page) (memory_bm_clear_bit(&pageset1_map, page_to_pfn(page)))

#define PagePageset1Copy(page) (memory_bm_test_bit(&pageset1_copy_map, page_to_pfn(page)))
#define SetPagePageset1Copy(page) (memory_bm_set_bit(&pageset1_copy_map, page_to_pfn(page)))
#define ClearPagePageset1Copy(page) \
	(memory_bm_clear_bit(&pageset1_copy_map, page_to_pfn(page)))

#define PagePageset2(page) (memory_bm_test_bit(&pageset2_map, page_to_pfn(page)))
#define SetPagePageset2(page) (memory_bm_set_bit(&pageset2_map, page_to_pfn(page)))
#define ClearPagePageset2(page) (memory_bm_clear_bit(&pageset2_map, page_to_pfn(page)))

#define PageWasRW(page) (memory_bm_test_bit(&pageset2_map, page_to_pfn(page)))
...
#define PageResave(page) (page_resave_map.zone_bm_list ? \
...
#define PageNosave(page) (nosave_map.zone_bm_list ? \
...
#define PageNosaveFree(page) (free_map.zone_bm_list ? \
